...
require('config.php');
   if(isset($_GET['code'])){
	       ...
	       //daca am primit codul atunci fac un post catre ... pt a obtine token-ul
		    ...
		    $cod=base64_encode("354a5a94-d2ca-11ed-afa1-0242ac120002:DIASfKsnmtYCpWyv");
				$curl = curl_init();
				...
				CURLOPT_POSTFIELDS=>'code='.$_GET['code'].'&grant_type=authorization_code&client_id=354a5a94-d2ca-11ed-afa1-0242ac120002&redirect_uri=http://172.99.1.130/medicinamuncii/indexlog.php',   //achizitii.antibiotice.ro //localhost/achizitii/
